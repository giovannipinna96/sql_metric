...
def process_inputs(sql_gold, sql_gen, dropdown_value):
    ...
    interpreter = DatabaseInterpreterPandas(dropdown_value, '/mnt/data/gpinna/lisbona_sql_metric/sql_metric/data/raw_data/dev')
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        common_keywords = gr.Textbox(label="Equal keywords")
